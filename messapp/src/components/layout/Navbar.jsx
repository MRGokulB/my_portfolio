            ...
            <div className={cn(
                ...
                <div className="hidden md:flex items-center gap-6">
                    ...
                    {user ? (
                        <a
                            href="/portal"
                            className="ml-2 px-4 py-2 bg-dark-900 text-white text-sm font-bold rounded-full hover:bg-black transition-all shadow-md"
                        >
                            Dashboard
                        </a>
                    ) : (
                        <a
                            href="/login"
                            className="ml-2 text-sm font-bold text-gray-500 hover:text-dark-900 transition-colors"
                        >
                            Log In
                        </a>
                    )}
                        ...
                        <div className="flex flex-col gap-6 text-center w-full max-w-sm px-6 relative z-10">
                            ...
                            >
                                ...
                                {user ? (
                                    <a
                                        href="/portal"
                                        className="block text-center mt-4 text-sm font-bold text-dark-900 bg-white shadow-sm py-3 rounded-xl border border-gray-100"
                                    >
                                        Go to Dashboard
                                    </a>
                                ) : (
                                    <a
                                        href="/login"
                                        className="block text-center mt-4 text-sm font-bold text-gray-500 hover:text-dark-900"
                                    >
