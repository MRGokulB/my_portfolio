...
const SubscriberCRM = () => {
    ...
    const handleAddMember = (e) => {
        ...
        setNewMember({ name: '', email: '', phone: '', planId: PLAN_TYPES.FULL_TIFFIN_1M.id });
    };
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex gap-2 w-full md:w-auto">
                    <button
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-dark-900 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg hover:bg-black transition-all"
                    >
                        <Smartphone size={18} />
                        <span>Print QR</span>
                    </button>
                    <button
                        ...
                        className="flex-1 md:flex-none flex items-center justify-center gap-2 bg-primary-500 text-white px-4 py-2 rounded-xl text-sm font-bold shadow-lg shadow-primary-500/20 hover:bg-primary-600 transition-all"
                    >
                        <Plus size={18} />
                ...
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl animate-fade-in-up">
                        <div className="bg-white p-6 text-center border-b border-gray-100">
                            <h3 className="text-xl font-bold text-dark-900">Attendance QR Code</h3>
                            <p className="text-xs text-gray-400 mt-1">Print this and stick it at your mess entrance.</p>
                        </div>
                        <div className="p-8 flex flex-col items-center">
                            <div className="bg-white p-4 rounded-xl border-2 border-dashed border-gray-200 shadow-sm" id="qr-code-area">
                                <img
                                    src="https://api.qrserver.com/v1/create-qr-code/?size=250x250&data=MANE_MESS_ATTENDANCE"
                                    alt="Attendance QR"
                                    className="w-48 h-48 object-contain"
                                />
                                <p className="mt-4 text-xs font-bold text-center text-gray-400 tracking-widest uppercase">SCAN TO MARK ATTENDANCE</p>
                            </div>
                        </div>
                        <div className="p-6 bg-gray-50 flex gap-3">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    printWindow.document.write('<h1>Mane Mess Attendance</h1>');
                                    printWindow.document.write('<img src="https://api.qrserver.com/v1/create-qr-code/?size=400x400&data=MANE_MESS_ATTENDANCE" style="width:400px;height:400px;margin:20px 0;" />');
                                    printWindow.document.write('<p style="font-weight:bold;font-size:20px;">SCAN TO EAT</p>');
                                    printWindow.document.write('</body></html>');
                                    printWindow.document.close();
                                    printWindow.print();
                                }}
                                className="flex-1 py-3 bg-dark-900 text-white font-bold rounded-xl shadow-lg hover:bg-black transition-all flex items-center justify-center gap-2"
                            >
                                <Smartphone size={18} />
                                Print Now
                            </button>
